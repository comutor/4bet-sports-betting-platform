...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Live Events Endpoint - Internal proxy to events/by-date with live filtering
  app.get("/api/live-events", async (req, res) => {
    try {
      // Make an internal HTTP request to our working events/by-date endpoint
      const today = new Date().toISOString().split('T')[0];
      const url = `http://localhost:5000/api/events/by-date?date=${today}`;
      ...
      const allTodayEvents = await response.json();
      
      // Filter for live events only
      const liveEvents = allTodayEvents.filter((event: any) => event.status === 'live');
      
      // Transform to live events format with proper sport mapping
      const transformedLiveEvents = liveEvents.map((event: any) => ({
        id: `live-${event.id}`,
        ...
        league: event.league,
        currentTime: event.currentTime || 'Live',
        odds: event.odds || {
          home: 2.50,
          draw: 3.20,
          away: 2.80
      ...
      console.log(`Found ${transformedLiveEvents.length} live events from today's matches`);
      res.json(transformedLiveEvents);
  ...
  app.get("/api/league/:leagueKey/matches", async (req, res) => {
    try {
      ...
      const leagueApiKeyMap: { [key: string]: string } = {
        ...
        'czech-first-league': 'soccer_czech_first_league',
        ...
        'hungarian-nb-i': 'soccer_hungary_nb_i',
        'croatian-hnl': 'soccer_croatia_hnl',
        'serbian-superliga': 'soccer_serbia_superliga',
        'bulgarian-first-league': 'soccer_bulgaria_first_league',
        'romanian-liga-1': 'soccer_romania_liga_1',
        'slovenian-prvaliga': 'soccer_slovenia_prvaliga',
        'slovakian-super-liga': 'soccer_slovakia_super_liga',
        // South American leagues
        'primera-division-uruguay': 'soccer_uruguay_primera_division',
        'primera-division-chile': 'soccer_chile_primera_division',
        'primera-division-colombia': 'soccer_colombia_primera_a',
        'primera-division-peru': 'soccer_peru_primera_division',
        'serie-a-ecuador': 'soccer_ecuador_serie_a',
        'liga-profesional-bolivia': 'soccer_bolivia_liga_profesional',
        'primeira-divisao-paraguay': 'soccer_paraguay_primera_division',
        'primera-division-venezuela': 'soccer_venezuela_primera_profesional',
        // Asian leagues
        'j-league': 'soccer_japan_j_league',
        'k-league': 'soccer_south_korea_k_league',
        'chinese-super-league': 'soccer_china_super_league',
        'indian-super-league': 'soccer_india_super_league',
        'thai-premier-league': 'soccer_thailand_premier_league',
        'singapore-premier-league': 'soccer_singapore_premier_league',
        'malaysian-super-league': 'soccer_malaysia_super_league',
        'indonesian-liga-1': 'soccer_indonesia_liga_1',
        'vietnamese-v-league': 'soccer_vietnam_v_league',
        'uae-pro-league': 'soccer_uae_pro_league',
        'saudi-pro-league': 'soccer_saudi_arabia_pro_league',
        'qatari-stars-league': 'soccer_qatar_stars_league',
        'iranian-pro-league': 'soccer_iran_pro_league',
        'iraqi-premier-league': 'soccer_iraq_premier_league',
        // African leagues
        'south-african-psl': 'soccer_south_africa_psl',
        'egyptian-premier-league': 'soccer_egypt_premier_league',
        'nigerian-npfl': 'soccer_nigeria_npfl',
        'kenyan-premier-league': 'soccer_kenya_premier_league',
        'ghanaian-premier-league': 'soccer_ghana_premier_league',
        'moroccan-botola': 'soccer_morocco_botola_pro',
        'tunisian-ligue-1': 'soccer_tunisia_ligue_1',
        'algerian-ligue-1': 'soccer_algeria_ligue_1',
        // Basketball leagues
        'nba-g-league': 'basketball_nba_g_league',
        'ncaa-basketball': 'basketball_ncaa',
        'fiba-world-cup': 'basketball_fiba_world_cup',
        'eurobasket': 'basketball_eurobasket',
        'olympics-basketball': 'basketball_olympics',
        // Tennis tournaments  
        'australian-open': 'tennis_australian_open',
        'french-open': 'tennis_french_open',
        'wimbledon': 'tennis_wimbledon',
        'us-open-tennis': 'tennis_us_open',
        'atp-masters-1000': 'tennis_atp_masters_1000',
        'wta-1000': 'tennis_wta_1000',
        'atp-finals': 'tennis_atp_finals',
        'wta-finals': 'tennis_wta_finals',
        'davis-cup': 'tennis_davis_cup',
        'fed-cup': 'tennis_fed_cup',
        'olympics-tennis': 'tennis_olympics',
        // Hockey leagues
        'khl': 'icehockey_khl',
        'shl': 'icehockey_sweden_hockey_league',
        'liiga': 'icehockey_finland_liiga',
        'czech-extraliga': 'icehockey_czech_extraliga',
        'slovakia-extraliga': 'icehockey_slovakia_extraliga',
        'swiss-national-league': 'icehockey_switzerland_nl',
        'deutsche-eishockey-liga': 'icehockey_germany_del',
        'austrian-ebel': 'icehockey_austria_ebel',
        'continental-cup': 'icehockey_continental_cup',
        'champions-hockey-league': 'icehockey_chl',
        'iihf-world-championship': 'icehockey_iihf_world_championship',
        'world-juniors': 'icehockey_world_juniors',
        'olympics-hockey': 'icehockey_olympics',
        // Cricket tournaments
        'ipl': 'cricket_ipl',
        'big-bash-league': 'cricket_big_bash',
        'county-championship': 'cricket_county_championship',
        't20-blast': 'cricket_t20_blast',
        'hundred': 'cricket_hundred',
        'caribbean-premier-league': 'cricket_cpl',
        'pakistan-super-league': 'cricket_psl',
        'bangladesh-premier-league': 'cricket_bpl',
        'sri-lanka-premier-league': 'cricket_slpl',
        'afghanistan-premier-league': 'cricket_apl',
        'world-cup-cricket': 'cricket_world_cup',
        't20-world-cup': 'cricket_t20_world_cup',
        'champions-trophy': 'cricket_champions_trophy',
        'olympics-cricket': 'cricket_olympics'
      };
