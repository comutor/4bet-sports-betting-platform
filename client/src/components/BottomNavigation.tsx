      ...
      <div className="relative">
        ...
        <div className="border-t border-gray-700 relative">
          ...
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-px">
            <div className="w-20 h-8 bg-slate-custom rounded-b-full"></div>
          </div>
        </div>
            ...
            >
              {index === 2 ? (
                ...
                <div className="flex flex-col items-center -mt-6">
                  <div className="w-14 h-14 bg-transparent border-2 border-white rounded-full flex items-center justify-center mb-2 relative shadow-lg">
