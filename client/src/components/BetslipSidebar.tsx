...
export function BetslipSidebar({
  ...
  return (
    <div 
      className={`fixed top-0 right-0 w-full lg:w-1/2 h-full bg-slate-custom z-50 ${
            ...
            items.map((item) => (
              <div key={item.id} className="bg-slate-light-custom rounded-lg p-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="font-bold text-white betslip-odds">{item.odds}</span>
                  <Input
                    type="number"
            ...
            <div className="bg-slate-light-custom rounded-lg p-4">
              ...
              <div className="mt-4 pt-4 border-t border-gray-600">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="font-bold text-lg text-white betslip-odds">{accumulatorOdds.toFixed(2)}</span>
                </div>
                <div className="flex items-center justify-between">
