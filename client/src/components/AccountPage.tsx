        ...
        <div className="space-y-3">
          {!isLoggedIn ? (
            <div className="grid grid-cols-2 gap-3">
              ...
              <Button 
                variant="outline" 
                className="border-2 border-white text-black hover:bg-yellow-400 hover:text-black hover:border-yellow-400 transition-all duration-300 hover:scale-105 font-bold py-4 text-sm"
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button 
                className="bg-transparent border-2 border-white text-black hover:bg-yellow-400 hover:text-black hover:border-yellow-400 transition-all duration-300 hover:scale-105 font-bold py-4"
              ...
              <Button 
                variant="outline" 
                className="border-2 border-white text-black hover:bg-yellow-400 hover:text-black hover:border-yellow-400 transition-all duration-300 hover:scale-105 font-bold py-4"
